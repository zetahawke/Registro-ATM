       ...
       {%>
        ...
        <fieldset>
            ...
            <div id="Iz">
                ...
                <div class="editor-field">
                    <%: Html.DropDownListFor(model => model.BancoAtm,
                        new[] 
                        { 
                            new SelectListItem {Value = "Prosegur", Text = "Prosegur"}, 
                            new SelectListItem {Value = "Wagner", Text = "Wagner"},
                            new SelectListItem {Value = "Brincks", Text = "Brincks"}
                        }
                        , "Seleccione...")%>
            ...
            <div id="der">
                ...
                <input id="Boton" type="submit" value="Ingresar ATM" />
            </div>
        </fieldset>
